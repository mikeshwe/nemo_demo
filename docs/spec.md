...
* **Local Components (macOS):** Python Agent Orchestrator (LangChain), Agent Memory/State (Redis/SQLite in Docker), and the custom Tool functions.
...
The agent runs locally but utilizes remote, high-performance NIMs for the core LLM intelligence.
